import svgPaths from "./svg-5tx85a08ia";
  ...
  return (
    <div className="h-[47px] relative shrink-0 w-[36px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 36 47">
        <g id="Icon">
          <path clipRule="evenodd" d={svgPaths.p21d40680} fill="var(--fill-0, #2A2A2A)" fillRule="evenodd" id="Vector 1" stroke="var(--stroke-0, #2A2A2A)" strokeWidth="0.10302" />
        </g>
      </svg>
    </div>
  );
